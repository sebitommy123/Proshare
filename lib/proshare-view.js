...
export default class ProshareView {
  ...
  setupProjectsView(){
    ...
    this.element.innerHTML += `<div> Hello <a href='#' style='display: inline;'>${this.loggedUsername}</a></div>`;
    ...
    rlButton.onclick = this.setupProjectsView;

    this.element.appendChild(rlButton);

    this.fetchProjects(instance.showTreeView);
